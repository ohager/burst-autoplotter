...
const DefaultOptionList = [{ name: 'cache', alias: 'c', type: String, description: "Set cache file", typeLabel: "<filename>" }, { name: 'help', alias: 'h', type: Boolean, description: "Get help for current command" }, { name: 'version', alias: 'v', type: Boolean, description: "Prints out version without plotter" }];
